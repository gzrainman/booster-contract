...
abstract contract Ownable is Context {
    ...
    /**
     * @dev receive owner
     * Can only be called by future owners
     */
    function receiveOwnership() public virtual {
        require(_newOwner == _msgSender(), "Ownable: caller is not the newOwner");
        _setOwner(_newOwner);
    }
...
contract TeamTokenVesting is Ownable {
    ...
    */
    ...
    constructor(IERC20 _token, uint32 _startTime) {
        tgb_token = _token;
        startTime = _startTime;
        totalSupply = tgb_token.totalSupply();
    }
    ...
    function teamTokenFunc() public view returns (uint) {
        ...
        if(t ==0 ){
            ...
            return totalSupply.mul(3).div(100);
        }else if(t == 2 && team_release == (totalSupply.mul(3).div(100))){
            return totalSupply.mul(335).div(10000);
        }else if(t == 3 && team_release == (totalSupply.mul(635).div(10000))){
            return totalSupply.mul(365).div(10000);
        }else{
            return 0;
        }
    }
    ...
    */
    function teamRelease(address recipient) public virtual onlyOwner returns (bool){
        ...
        team_release = team_release.add(amount);
        tgb_token.safeTransfer(recipient, amount);
        return true;
    }
    ...
    function investorTokenFunc() public view returns (uint) {
        ...
        if(t ==0 && investor_release == 0){
            return totalSupply.mul(9).div(100);
        }else if(t == 1 && investor_release == totalSupply.mul(9).div(100)){
            return totalSupply.mul(2).div(100);
        }else if(t == 2 && investor_release == (totalSupply.mul(11).div(100))){
            return totalSupply.mul(35).div(1000);
        }else if(t == 3 && investor_release == (totalSupply.mul(145).div(1000))){
            return totalSupply.mul(45).div(1000);
        }else{
            return 0;
        }
    }
    ...
    */
    function investorRelease(address recipient) public virtual onlyOwner returns (bool){
        ...
        investor_release = investor_release.add(amount);
        tgb_token.safeTransfer(recipient, amount);
        return true;
    }
    ...
    function setStartTime(uint32 beforeDay) public virtual  onlyOwner{
        uint32 beferTime = beforeDay*86400;
    ...
    */
    function _calYear() internal view returns (uint32) {
        ...
        uint32 SECONDS_PER_YEAR = 31536000;
